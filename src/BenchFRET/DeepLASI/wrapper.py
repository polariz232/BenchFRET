    ...
    def predict(self, traces=[], n_colors=None, n_states=None, deeplasi_mode="fast", progress_callback=None):
        ...
        if correct_format:
            ...
            if deeplasi_mode.lower() == "fast":
                ...
                for index, (trace, label, n_states) in tqdm(enumerate(zip(traces, trace_labels, n_states_prediction)),total=traces.shape[0]):
                ...
                for index, trace in tqdm(enumerate(traces)):
                    ...
                    if trace_label[0] != "dynamic":
                        ...
                        if n_states is None:
                            ...
                            # use the user defined number of statess
